...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="/Tickets/Application/Home/Common/Resources/css/User_Login.css" type="text/css" rel="stylesheet" />
                    ...
                    <form action="<?php echo U('Index/loginCheck');?>" method="post">
                        <ul>
                            ...
                            <li class="user_main_r">
                                ...
                                <input style="border: medium none; background: url(/Tickets/Application/Home/Common/Resources/img/user_botton.gif) repeat-x scroll left top transparent; height: 122px; width: 111px; display: block; cursor: pointer;" value="" type="submit">
                            </li>
                        </ul>
                    </form>
                </dd>
