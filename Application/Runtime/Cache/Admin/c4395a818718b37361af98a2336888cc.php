    ...
    <div class="content-box">
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
         ...
         <form action="<?php echo U('Shop/add');?>" method="post" enctype="multipart/form-data">
      <p>
       <strong>门 店 名 称：</strong>
        <input class="text-input" type="text"  name="shop_name" />
      </p>
      <div class="clear"></div>
       <p>
       <strong>人 数 上 限：</strong>
        <select name="limit">
       			<?php $__FOR_START_23948__=1;$__FOR_END_23948__=51;for($i=$__FOR_START_23948__;$i < $__FOR_END_23948__;$i+=1){ ?><option value="<?php echo ($i); ?>"><?php echo ($i); ?></option><?php } ?>
        </select>  人
      </p>
      <div class="clear"></div>
      <p >
        <input class="button-register" type="submit" value="添 加" />
      </p>
    </form>
        </div>
        <!-- End #tab1 -->
