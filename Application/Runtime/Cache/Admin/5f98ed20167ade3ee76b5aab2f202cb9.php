  ...
  <div id="main-content">
    ...
    <div class="content-box">
      ...
      <div class="content-box-header">
        <h3>为所有门店添加品鉴会（注：相同日期、时间，不同门店）</h3>
        <div class="clear"></div>
      </div>
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
         ...
         <form action="<?php echo U('Tasting/addAllShop');?>" method="post">
       <p>
       <strong>品鉴会日期：</strong> 
          <select name="date_y">
       			<?php $__FOR_START_27085__=2016;$__FOR_END_27085__=2500;for($i=$__FOR_START_27085__;$i < $__FOR_END_27085__;$i+=1){ ?><option value="<?php echo ($i); ?>"><?php echo ($i); ?></option><?php } ?>
          </select> 年
          <select name="date_m">
       			<?php $__FOR_START_12930__=1;$__FOR_END_12930__=13;for($i=$__FOR_START_12930__;$i < $__FOR_END_12930__;$i+=1){ ?><option value="<?php echo ($i); ?>"><?php echo ($i); ?></option><?php } ?>
         </select> 月
         <select name="date_d">
       			<?php $__FOR_START_19859__=1;$__FOR_END_19859__=32;for($i=$__FOR_START_19859__;$i < $__FOR_END_19859__;$i+=1){ ?><option value="<?php echo ($i); ?>"><?php echo ($i); ?></option><?php } ?>
        </select> 日
      </p>
      <div class="clear"></div>
      <p>
       <strong>品鉴会时间：</strong> 
       <select name="time_h">
       			<?php $__FOR_START_464__=0;$__FOR_END_464__=24;for($i=$__FOR_START_464__;$i < $__FOR_END_464__;$i+=1){ ?><option value="<?php echo ($i); ?>"><?php echo ($i); ?></option><?php } ?>
        </select> 时
        <select name="time_m">
       			<?php $__FOR_START_21961__=0;$__FOR_END_21961__=60;for($i=$__FOR_START_21961__;$i < $__FOR_END_21961__;$i+=1){ ?><option value="<?php echo ($i); ?>"><?php echo ($i); ?></option><?php } ?>
        </select> 分
      </p>
      <div class="clear"></div>
      <p > 
        <input class="button-register" type="submit" value="全 部 添 加" />
      </p>
    </form>
        </div>
        <!-- End #tab1 -->
