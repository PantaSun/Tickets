      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
          <!-- This is the target div. id must match the href of this div's tab -->
           ...
           <tbody>
           <?php if(is_array($list)): foreach($list as $key=>$salesman): ?><tr>
                <td><?php echo ($id++); ?></td>
                <td><?php echo ($salesman["user_name"]); ?></td>
                <td><?php echo ($salesman["user_shop_name"]); ?> </td>               
                <!--<td><?php echo ($salesman["user_sale"]); ?> </td>-->
                <td><a href="<?php echo U('User/deleteSalesman',array('username'=>$salesman['user_name']));?>" onclick="return confirm('是否确认删除？');">删除</a> </td>
