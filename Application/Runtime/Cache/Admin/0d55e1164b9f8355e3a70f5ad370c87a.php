    ...
    <div class="content-box">
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
          ...
          <form action="<?php echo U('Tasting/deleteTastings');?>" method="post">
           <table>
            <thead>
              <tr>
                <th>序 号</th>
           ...
           <tbody>
           <?php if(is_array($list)): foreach($list as $key=>$tasting): ?><tr>
                <td><?php echo ($id++); ?></td>
                <td><?php echo ($tasting["tasting_shop_name"]); ?></td>
                <td><?php echo ($tasting["tasting_date_y"]); ?> 年<?php echo ($tasting["tasting_date_m"]); ?> 月<?php echo ($tasting["tasting_date_d"]); ?> 日</td>               
                <td><?php echo ($tasting["tasting_time_h"]); ?> 时<?php echo ($tasting["tasting_time_m"]); ?> 分</td>
                <td><form action="<?php echo U('Tasting/modifyCount');?>" method="post">
                 <input class="text-input" type="text"  name="new_tasting_count"  value="<?php echo ($tasting["tasting_count"]); ?>"/>
                 <input class="text-input" type="hidden"  name="tasting_id" value="<?php echo ($tasting["tasting_id"]); ?>"/>
                    <input class="button-submit" type="submit" value="修 改"  onclick="return confirm('是否确认修改？此项为重要数据，请谨慎修改！！！');" />
                    </form></td>
                <td><a href="<?php echo U('Tasting/deleteTasting',array('tasting_id'=>$tasting['tasting_id']));?>" onclick="return confirm('是否确认删除？');">删除</a> </td>
              	<td><input name="<?php echo ($id-1); ?>" type="checkbox" value="<?php echo ($tasting["tasting_id"]); ?>">  </td>
              ...
              <tr>
                <td colspan="6">
                  ...
                  <input class="button" type="submit" value="批量删除选中项" />
                    </div>
