  ...
  <div id="main-content">
    ...
    <div class="content-box">
      ...
      <div class="content-box-content">
        ...
        <form action="<?php echo U('modifySalesman');?>" method="post" >
          <p>
              <strong>账号查找：</strong>
              <input class="text-input" type="text"  name="username" placeholder="请输入要修改信息的账号"/>
          </p>
          <div class="clear"></div>
          
            <p >
            <input class="button-register" type="submit" value="查 询" />
            </p>
        </form>
        </div>
        <!-- End #tab1 -->
